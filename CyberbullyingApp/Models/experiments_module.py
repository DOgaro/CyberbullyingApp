...
def experiment1(X,y): # """Different Classifiers"""
...
def experiment2(X,y): #"""Different features with SVM"""
    ...
    svm2=Pipeline([('vect',CountVectorizer(stop_words=stop)),('svm',SVC(kernel="linear",C=1))])
